...
'********************************************************************
'module for saving the data/settings to a file ..
'I've could do it by writing to the registery.. but i don't like it , because.
'so the registers will grow and.. you know.. :-)
'The file is called    SettingNet.INI
'
'Peter Verburgh
'********************************************************************
Option Explicit
